import MaxWidtchWrapper from "@/components/max-width-wrapper";
...
export default function Home() {
  return (
    <>
      <MaxWidtchWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        <div
